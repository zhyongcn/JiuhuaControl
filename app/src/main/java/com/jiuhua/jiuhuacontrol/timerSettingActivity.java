...
////                MQTTService.publish("86518/JYCFGC/6-2-3401/IndoorDB", periodString[0], 1, false);
...
//                Toast.makeText(timerSettingActivity.this, periodString[0], Toast.LENGTH_SHORT).show();//最后要去掉
//                //结尾加上标识符便于模块区分
//                MQTTService.publish("86518/JYCFGC/6-2-3401/IndoorDB", periodString[0].concat("Room1winterperoid"), 1, false);
//                MQTTService.publish("86518/JYCFGC/6-2-3401/IndoorDB", periodString[1].concat("Room2winterperoid"), 1, false);
