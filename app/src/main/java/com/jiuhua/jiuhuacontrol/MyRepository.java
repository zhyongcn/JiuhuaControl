...
//    List<BasicInfoDB> allBasicInfo;
    ...
    LiveData<List<IndoorDB>> allIndoorDBLive;
...
//        allBasicInfo = indoorDao.loadAllBasicInfo();  //相关于Dao里面的一个有问题的方法。
        allBasicInfoLive = indoorDao.loadAllBasicInfoLive();
        allIndoorDBLive = indoorDao.loadCurrentIndoorDBsLive();
