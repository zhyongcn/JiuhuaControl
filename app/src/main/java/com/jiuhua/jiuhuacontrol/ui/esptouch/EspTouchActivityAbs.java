...
public abstract class EspTouchActivityAbs extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        MenuItemCompat.setShowAsAction(menu.add(Menu.NONE, MENU_ITEM_ABOUT, 0, R.string.menu_item_about)
                .setIcon(R.drawable.ic_info_outline_white_24dp), MenuItem.SHOW_AS_ACTION_IF_ROOM);
